...
*** page-break-lines
#+begin_src emacs-lisp
          (use-package page-break-lines :ensure :config (page-break-lines-mode 1))
...
** lisp
   #+BEGIN_SRC emacs-lisp
     ...
     (defun my-slime-ac-thing ()
       (set-up-slime-ac t))

     (use-package ac-slime
       :ensure
       :config (progn
                 (add-hook 'slime-mode-hook 'my-slime-ac-thing)
                 (add-hook 'slime-repl-mode-hook 'my-slime-ac-thing)
