...
* email stuff
  ...
  #+BEGIN_SRC emacs-lisp :results output silent
    (use-package mu4e  
      :load-path (if (eq system-type 'darwin)
                     "/usr/local/share/emacs/site-lisp/mu/mu4e/"
                   "/usr/share/emacs/site-lisp/mu4e/")
      :commands (make-mu4e-context)
      :init (progn
              (setq
               mu4e-mu-binary (if (eq system-type 'darwin)
                                  "/usr/local/bin/mu"
                                  "/usr/bin/mu")
